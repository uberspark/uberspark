...
Our running example ``hello-mul`` requires the GNU gcc compiler v5.4.0, GNU Assembler and Linkers v2.26.1 (as
...
We now proceed with the task of paring away the ``hello-mul`` |coss| application as a single 
