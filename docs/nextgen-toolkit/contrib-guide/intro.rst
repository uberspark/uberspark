...
to the core |uberspark| framework including but not limited to: the front-end CLI, sentinels, hardware
models, loaders, bridges and the core |uberspark| tool libraries. 

.. note::   Ocaml imperative programming is a pre-requisite for developers wishing to contribute to the
            |uberspark| tool libraries and front-end CLI. All other components require the knowledge 
