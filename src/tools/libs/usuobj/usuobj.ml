		...
		method consolidate_hfiles_and_embed_sentinels
			...
			let uobj_sentinel_decls_filename = 
					(self#get_o_uobj_dir_abspathname ^ "/" ^ 
						self#get_o_usmf_hdr_id ^ "_sentinels.h") in
			let oc = open_out uobj_sentinel_decls_filename in
				Printf.fprintf oc "\n/* autogenerated uberSpark uobj sentinels declarations header */";
				Printf.fprintf oc "\n/* author: amit vasudevan (amitvasudevan@acm.org) */";

				Printf.fprintf oc "\n";
				Printf.fprintf oc "\n";
	
				Printf.fprintf oc "\n#ifndef __%s_sentinels_h__" self#get_o_usmf_hdr_id;
				Printf.fprintf oc "\n#define __%s_sentinels_h__" self#get_o_usmf_hdr_id;
				...
				Printf.fprintf oc "\n#endif //__%s_sentinels_h__" self#get_o_usmf_hdr_id;
				
			close_out oc;
			Uslog.logf log_tag Uslog.Info "Generated sentinel declarations.";
			(uobj_sentinel_decls_filename)
		;
