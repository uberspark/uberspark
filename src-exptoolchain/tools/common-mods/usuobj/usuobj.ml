...
(*																											
		...
		method generate_slt	
			...
			: bool	= 
				...
				(*Usconfig.namespace_uobjslt_output_data_filename*)

				Uslog.log ~lvl:Uslog.Debug "fn_list length=%u" (List.length fn_list);
				let oc = open_out Usconfig.namespace_uobjslt_output_code_filename in
					Printf.fprintf oc "\n/* --- this file is autogenerated --- */";
					Printf.fprintf oc "\n/* uberSpark sentinel linkage table - trampoline code */";
					Printf.fprintf oc "\n/* author: amit vasudevan (amitvasudevan@acm.org) */";
					Printf.fprintf oc "\n";
					Printf.fprintf oc "\n";
					List.iter (fun (x) ->
				...
				let oc = open_out Usconfig.namespace_uobjslt_output_data_filename in
					Printf.fprintf oc "\n/* --- this file is autogenerated --- */";
					Printf.fprintf oc "\n/* uberSpark sentinel linkage table - trampoline data */";
					Printf.fprintf oc "\n/* author: amit vasudevan (amitvasudevan@acm.org) */";
					Printf.fprintf oc "\n";
					Printf.fprintf oc "\n";
...
(*								
	...
	*)			
		...
		method initialize	
			...
			let rval = (self#generate_slt self#get_d_exitcallees_list ".uobjslt_exitcalles_tcode" ".uobjslt_exitcalles_tdata") in	
			if (rval == false) then
				begin
