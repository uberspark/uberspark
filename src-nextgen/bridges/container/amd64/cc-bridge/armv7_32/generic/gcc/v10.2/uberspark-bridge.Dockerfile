...
LABEL maintainer="Amit Vasudevan <amitvasudevan@acm.org>, Matt McCormack <matthew.mccormack@live.com>" author="Ethan Joseph <ethanj217@gmail.com>"
...
RUN apt-get update &&\
    apt-get -yqq install gcc-10-arm-linux-gnueabihf \
    	    	 	 gcc-10-multilib-arm-linux-gnueabihf \
			 binutils-arm-linux-gnueabihf &&\
    apt-get clean && rm -rf /var/lib/apt/lists/* &&\
    ln -s /usr/bin/arm-linux-gnueabihf-gcc-10 /usr/bin/gcc
