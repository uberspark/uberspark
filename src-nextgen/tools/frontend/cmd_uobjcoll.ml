...
let handler_uobjcoll_build
  ...
  if cmd_uobjcoll_opts.platform = "" then
    ...
    begin
      ...
      if (Uberspark.Uobjcoll.build uobjcoll_path_ns target_def Uberspark.Platform.json_node_uberspark_config_var.uobjcoll_binary_image_load_address) then begin
...
let handler_uobjcoll_verify
  ...
  if cmd_uobjcoll_opts.platform = "" then
    ...
    begin
      ...
      if (Uberspark.Uobjcoll.verify uobjcoll_path_ns target_def Uberspark.Platform.json_node_uberspark_config_var.uobjcoll_binary_image_load_address) then begin
