...
let handler_uobjcoll_build
  ...
  if cmd_uobjcoll_opts.platform = "" then
    ...
    begin
      ...
      if (Uberspark.Uobjcoll.build uobjcoll_path_ns target_def Uberspark.Platform.json_node_uberspark_platform_var.platform.binary.uobjcoll_image_load_address) then begin
...
let handler_uobjcoll_verify
  ...
  if cmd_uobjcoll_opts.platform = "" then
    ...
    begin
      ...
      if (Uberspark.Uobjcoll.verify uobjcoll_path_ns target_def Uberspark.Platform.json_node_uberspark_platform_var.platform.binary.uobjcoll_image_load_address) then begin
