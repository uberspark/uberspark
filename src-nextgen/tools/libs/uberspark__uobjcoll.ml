...
let consolidate_sections_with_memory_map
	...
	List.iter ( fun (sentinel_entry: Uberspark.Manifest.Uobjcoll.json_node_uberspark_uobjcoll_initmethod_sentinels_t) ->
		...
		(*let section_size = 	sentinel_info.sizeof_code_template + (Uberspark.Platform.json_node_uberspark_platform_var.binary.uobjcoll_image_section_alignment - 
			(sentinel_info.sizeof_code_template mod Uberspark.Platform.json_node_uberspark_platform_var.binary.uobjcoll_image_section_alignment)) in
		*)
