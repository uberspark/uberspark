...
let generate_src_binhdr
    ...
    Printf.fprintf oc "\n__attribute__(( section(\".uobj_binhdr\") )) usbinformat_hdr_t uobj_binhdr = {";
        ...
        Printf.fprintf oc "\n\t{"; 
            ...
            (*size*)
            Printf.fprintf oc "\n\t\t0x%08xULL," Uberspark.Platform.manifest_var.platform.binary.uobj_default_section_size; 
            (*aligned_at*)
            Printf.fprintf oc "\n\t\t0x%08xUL," Uberspark.Platform.manifest_var.platform.binary.uobj_section_alignment; 
            (*pad_to*)
            Printf.fprintf oc "\n\t\t0x%08xUL," Uberspark.Platform.manifest_var.platform.binary.uobj_section_alignment; 
            (*addr_start*)
            Printf.fprintf oc "\n\t\t0x%08xUL," load_addr; 
