...
let store 
	...
	: bool =
	let retval = ref false in 
    let bridge_ns = json_node_uberspark_bridge_casm_var.json_node_bridge_hdr_var.btype ^ "/" ^
		json_node_uberspark_bridge_casm_var.json_node_bridge_hdr_var.devenv ^ "/" ^
		...
		json_node_uberspark_bridge_casm_var.json_node_bridge_hdr_var.bname ^ "/" ^
	...
	if !retval && json_node_uberspark_bridge_casm_var.json_node_bridge_hdr_var.btype = "container" then
		begin
			let input_bridge_dockerfile = json_node_uberspark_bridge_casm_var.json_node_bridge_hdr_var.container_fname in 
...
let build 
	...
	if json_node_uberspark_bridge_casm_var.json_node_bridge_hdr_var.btype = "container" then
		begin
			let bridge_ns = Uberspark_namespace.namespace_bridge_as_bridge ^ "/" ^
				json_node_uberspark_bridge_casm_var.json_node_bridge_hdr_var.btype ^ "/" ^
				json_node_uberspark_bridge_casm_var.json_node_bridge_hdr_var.devenv ^ "/" ^
				json_node_uberspark_bridge_casm_var.json_node_bridge_hdr_var.arch ^ "/" ^
				json_node_uberspark_bridge_casm_var.json_node_bridge_hdr_var.cpu ^ "/" ^
				json_node_uberspark_bridge_casm_var.json_node_bridge_hdr_var.bname ^ "/" ^
...
let invoke 
	...
	(* invoke the compiler *)
	if json_node_uberspark_bridge_casm_var.json_node_bridge_hdr_var.btype = "container" then begin
