				...
				l_actions_list := !l_actions_list @ [
					{
						...
						input = [ "*.c" ]; output = [ ]; bridge_namespace = Uberspark.Platform.json_node_uberspark_platform_var.platform.bridges.uberspark_vf_bridge_namespace; bridge_cmd = [];
						uobj_namespace = "";
						uobjrtl_namespace = "";
						loader_namespace = "";
					};

					{
						...
						category = "translation";
						input = [ "*.c" ]; output = [ "*.o" ]; bridge_namespace = Uberspark.Platform.json_node_uberspark_platform_var.platform.bridges.cc_bridge_namespace; bridge_cmd = [];
						uobj_namespace = "";
						uobjrtl_namespace = "";
						loader_namespace = "";
					};

					{
						...
						category = "translation";
						input = [ "*.cS" ]; output = [ "*.o" ]; bridge_namespace = Uberspark.Platform.json_node_uberspark_platform_var.platform.bridges.casm_bridge_namespace; bridge_cmd = [];
						uobj_namespace = "";
						uobjrtl_namespace = "";
						loader_namespace = "";
					};

					{
						...
						category = "translation";
						input = [ "*.s" ]; output = [ "*.o" ]; bridge_namespace = Uberspark.Platform.json_node_uberspark_platform_var.platform.bridges.as_bridge_namespace; bridge_cmd = [];
						uobj_namespace = "";
						uobjrtl_namespace = "";
						loader_namespace = "";
					};
...
let initialize
	...
	let l_add_default_uobjcoll_actions () : 
		...
		l_uobjcoll_action.bridge_namespace <- Uberspark.Platform.json_node_uberspark_platform_var.platform.bridges.ld_bridge_namespace;
